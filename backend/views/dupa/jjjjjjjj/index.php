...
<div class="site-index">
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/jjjjjjjj/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/jjjjjjjj/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'jjjjjjjj-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Jjjjjjjj </button>
