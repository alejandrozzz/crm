...
<div class="site-index">
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/newmodule/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/newmodule/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'newmodule-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add NewModule </button>
