...
<div class="site-index">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/r/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'r-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add R </button>
