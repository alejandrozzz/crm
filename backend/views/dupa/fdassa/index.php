...
<div class="site-index">
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/fdassa/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/fdassa/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'fdassa-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Fdassa </button>
