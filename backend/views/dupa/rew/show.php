<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        ...
        <div class="col-md-1 actions">
            @la_access("Rew", "edit")
            <a href="{{ url(config('laraadmin.adminRoute') . '/rew/'.$rew->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access

            @la_access("Rew", "delete")
            {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rew.destroy', $rew->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rew') }}" data-toggle="tooltip" data-placement="right" title="Back to Rew"><i class="fa fa-chevron-left"></i></a></li>
