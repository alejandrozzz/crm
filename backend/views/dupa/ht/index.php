...
<div class="site-index">
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/ht/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/ht/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'ht-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Ht </button>
