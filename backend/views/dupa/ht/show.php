<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        ...
        <div class="col-md-1 actions">
            @la_access("Ht", "edit")
            <a href="{{ url(config('laraadmin.adminRoute') . '/ht/'.$ht->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access

            @la_access("Ht", "delete")
            {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ht.destroy', $ht->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ht') }}" data-toggle="tooltip" data-placement="right" title="Back to Ht"><i class="fa fa-chevron-left"></i></a></li>
