...
<div class="site-index">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test555/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'test555-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Test555 </button>
...
$(function () {
    $("#example1").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo Yii::$app->urlManager->createUrl(['dupa/'.strtolower("Test555").'/dtajax']) ?>",
        language: {
            lengthMenu: "_MENU_",
            search: "_INPUT_",
