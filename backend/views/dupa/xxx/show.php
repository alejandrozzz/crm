<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name"><?php echo $xxx->$view_col ?></h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
                ...
                <a href="<?php echo Yii::$app->urlManager->createUrl(['/dupa/xxx/edit', 'id' => $xxx->id]) ?>" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            
            
            
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.xxx.destroy', $xxx->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/xxx') }}" data-toggle="tooltip" data-placement="right" title="Back to Xxx"><i class="fa fa-chevron-left"></i></a></li>
