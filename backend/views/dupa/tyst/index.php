...
<div class="site-index">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/tyst/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'tyst-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Tyst </button>
...
$(function () {
    $("#example1").DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo Yii::$app->urlManager->createUrl(['dupa/Tyst/dtajax']) ?>",
        language: {
            lengthMenu: "_MENU_",
            search: "_INPUT_",
