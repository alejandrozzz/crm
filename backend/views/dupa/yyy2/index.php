...
<div class="site-index">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/yyy2/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'yyy2-add-form'
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<input type="text" name="colname" value="gfdf">
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Yyy2 </button>
