...
<div class="site-index">
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/asddsaf/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/asddsaf/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'asddsaf-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Asddsaf </button>
