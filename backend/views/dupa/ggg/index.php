...
<div class="site-index">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/ggg/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'ggg-add-form'
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<input type="text" name="colname" value="hkjkjh">
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Ggg </button>
