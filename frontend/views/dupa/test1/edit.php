...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test1 №<?=$test1['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test1/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test1-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test1['id'] ); ?>
