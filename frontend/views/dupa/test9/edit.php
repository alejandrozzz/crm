...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test9 №<?=$test9['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test9/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test9-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test9['id'] ); ?>
