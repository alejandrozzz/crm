	...
	<div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table">
                      ...
                      <tbody>
					  <?php foreach (Companies::find()->all() as $m) : ?>
						  <tr>
						  ...
						  <?php foreach($listing_cols as $col) : ?>
							...
							<?php endforeach;?>
							<td><?php echo Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->getUrlManager()->createUrl(['/dupa/companies/edit','id'=>$m->id])); ?></td>
							<td><?php echo Html::a('<span class="glyphicon glyphicon-remove"></span>', Yii::$app->getUrlManager()->createUrl(['/dupa/companies/destroy','id'=>$m->id])); ?></td>
                        </tr>
					  <?php endforeach;?>
                      </tbody>
                    </table>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add New Companies</h4>
			</div>
			...
			<div class="modal-body">
				<div class="box-body">
					...
					Do You really want to create a new instance of Companies module?
