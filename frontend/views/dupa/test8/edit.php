...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test8 №<?=$test8['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test8/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test8-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test8['id'] ); ?>
