...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Fgadgf №<?=$fgadgf['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/fgadgf/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'fgadgf-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $fgadgf['id'] ); ?>
