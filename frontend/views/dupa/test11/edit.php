...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test11 №<?=$test11['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test11/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test11-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test11['id'] ); ?>
