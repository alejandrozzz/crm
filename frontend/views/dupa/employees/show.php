    ...
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $employees->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            ...
            <a href="{{ url(config('laraadmin.adminRoute') . '/employees/'.$employees->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access

            @la_access("Employees", "delete")
            {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.employees.destroy', $employees->id], 'method' => 'delete', 'style'=>'display:inline']) }}
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
						...
						<input type="text" name="colname" value="user">
                    </div>
                </div>
            </div>
        </div>
