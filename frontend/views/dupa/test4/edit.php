...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test4 №<?=$test4['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test4/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test4-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test4['id'] ); ?>
