...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test3 №<?=$test3['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test3/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test3-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test3['id'] ); ?>

                <div class='form-group'><label class='control-label col-md-3 col-sm-3 col-xs-12' for='name'>name</label><div class='col-md-6 col-sm-6 col-xs-12'><input type="text" class="form-control col-md-7 col-xs-12" name="name" value=""></div></div><div class='form-group'><label class='control-label col-md-3 col-sm-3 col-xs-12' for='address'>address</label><div class='col-md-6 col-sm-6 col-xs-12'><input type="text" class="form-control col-md-7 col-xs-12" name="address" value=""></div></div>
