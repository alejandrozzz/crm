...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test7 №<?=$test7['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test7/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test7-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test7['id'] ); ?>
