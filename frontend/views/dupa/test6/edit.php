...
<div class="row">
	...
	<div class="x_panel">
                  <div class="x_title">
                    <h2>Test6 №<?=$test6['id']?> Edit Form</h2>
 ...
 <?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test6/update'], 'method' => 'post',
                    'options'                => [
                        'id'      => 'test6-edit-form',
						'class'	=> 'form-horizontal form-label-left',

                    ]]); ?>
                <?php echo Html::hiddenInput('id', $test6['id'] ); ?>
