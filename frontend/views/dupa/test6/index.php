...
<div class="row">
	...
	<div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table">
                      ...
                      <tbody>
					  <?php foreach (Test6::find()->all() as $m) : ?>
						  <tr>
    ...
    <?php $listing_cols[] =[ 'class' => ActionColumn::className(),
        'buttons' => [
            'view' => function ($url, $model, $key) {
                $customurl=Yii::$app->getUrlManager()->createUrl(['/dupa/test6/edit','id'=>$model['id']]);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<?php $form = ActiveForm::begin([ 'enableClientValidation' => true, 'action'	=> ['dupa/test6/store'], 'method' => 'post',
                'options'                => [
                    'id'      => 'test6-add-form'
...
<button class="btn btn-success btn-sm pull-right add_new_module_btn">Add Test6 </button>
	</div>
</div>
<script>
	$(function(){
