...
//    }
    ...
    public function actionStore()
    {
        //if(Module::hasAccess("Files", "create")) {
           ...
           // }
            ...
            $insert_id = Module::insertModule("Files", Yii::$app->request->post());
    ...
    public function actionShow()
    {
        //if(Module::hasAccess("Files", "view")) {
            ...
            $files = Files::find()->where('id = ' . Yii::$app->request->get('id'))->one();
            if(isset($files->id)) {
                $module = Module::getModule('Files');
                $module->row = $files;
    ...
    public function actionUpdate()
    {
            ...
            $insert_id = Module::updateRow("Files", Yii::$app->request->post(), Yii::$app->request->post('id'));
